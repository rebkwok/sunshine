            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=6,
                        help_text="How many months will this gift voucher last?",
                    ),
                ),
                (
                    "override_cost",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Use this to override the default cost to purchase this gift voucher. (Default cost is the current cost of the item the voucher is for (i.e. the discount amount, or for memberships, the current cost to purchase that membership, and for classes/privates/workshops, the cost of the last event of that type that was created.",
                        max_digits=8,
                        null=True,
                    ),
                ),
