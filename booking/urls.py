...
urlpatterns = [
    ...
    path(
        "membership-detail/<int:pk>/",
        MembershipDetailView.as_view(),
        name="membership_detail",
    ),
    path("booking-history/", BookingHistoryListView.as_view(), name="booking_history"),
    path(
        "classes/", RegularClassesEventListView.as_view(), name="regular_session_list"
    ),
    ...
    path(
        "gift-vouchers/<slug:slug>/update",
        GiftVoucherUpdateView.as_view(),
        name="gift_voucher_update",
    ),
    path(
        "gift-vouchers/<slug:slug>",
        GiftVoucherDetailView.as_view(),
        name="gift_voucher_details",
    ),
    ...
    path(
        "ajax-membership-purchase/",
        ajax_add_membership_to_basket,
        name="ajax_add_membership_to_basket",
    ),
    # SHOPPING BASKET
