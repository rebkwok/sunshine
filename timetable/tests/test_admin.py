...
def test_venue_admin():
    venue = baker.make(Venue, location__address="1 Main St", location__postcode="AAA 111")
    image_file = SimpleUploadedFile(name="venue.jpg", content=b'test', content_type="image/jpeg")
...
def test_session_type_admin():
    ...
    image_file = SimpleUploadedFile(name="session_type.jpg", content=b'test', content_type="image/jpeg")
