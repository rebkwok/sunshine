...
class TimetableListView(ListView):
    ...
    def get_queryset(self):
        queryset = (
            TimetableSession.objects.filter(show_on_timetable_page=True)
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        form = TimetableFilter(initial={"filtered_session_type": session_type})
        ...
        for index, location_choice in venue_locations:
            ...
            location_events.append(
                {"index": index, "queryset": queryset, "location": location_choice}
            )
