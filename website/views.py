...
def home(request):
    ...
    return render(
        ...
        "website/home.html",
        {
            ...
            "gallery_categories": set(images.values_list("category__name", flat=True))
            - {None},
...
def home_legacy(request):
    ...
    return render(
        request,
        "website/home_legacy.html",
        {"section": "home", "class_types": class_types},
    )
...
def process_contact_form(request, template_name):
    ...
    if form.is_valid():
        ...
        return_url = request.session.get("return_url", reverse("website:contact"))
        messages.success(
            request,
            "Thanks for your enquiry!  Your email has been sent and we'll be in touch soon.",
        )
        return HttpResponseRedirect(return_url)

    else:
        messages.error(request, "Please correct the errors below")
        return render(request, template_name, {"section": "about", "form": form})
...
def session_types(request):
    return render(
        request,
        "website/session_types.html",
        {
            "section": "about",
            "session_types": SessionType.objects.filter(display_on_site=True),
        },
    )
