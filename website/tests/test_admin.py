...
def test_gallery_image_admin():
    ...
    assert re.match(
        r'<img src="\/media\/images\/gallery\/image.*\.jpg"  height="60px"/>',
        gallery_image_admin.image_img(gallery_image_with_photo),
    )
...
def test_team_member_admin():
    ...
    assert re.match(
        r'<img src="\/media\/images\/team\/image.*\.jpg"  height="60px"/>',
        team_member_admin.image_img(team_member_with_photo),
    )
